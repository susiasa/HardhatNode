...
#[derive(Debug)]
pub struct HardhatNodeProcessor {
    verbose: bool,
    processed_count: usize,
}

impl HardhatNodeProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting HardhatNode processing");
    
    let mut processor = HardhatNodeProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = HardhatNodeProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = HardhatNodeProcessor::new(false);
